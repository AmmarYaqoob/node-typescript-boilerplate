...
var sequelize = new sequelize_1.Sequelize(config_1.config.database, config_1.config.db_user, config_1.config.db_pass, {
    host: config_1.config.db_server,
    dialect: config_1.config.db_type,
    port: 3306,
...
var bootstrapDatabase = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
